...
function calcular(){
    ...
    if (erro){
        ...
        setTimeout(() => {
            ...
            error.innerHTML += `O <span style="color: red">Huguinho</span> economizou <b>R$${(economia[economia.length - 1].filho1).toFixed(2)}</b> pois fez ${filho1} depósitos <br>`
            error.innerHTML += `O <span style="color: blue">Zezinho</span> economizou <b>R$${(economia[economia.length - 1].filho2).toFixed(2)}</b> pois fez ${filho2} depósitos <br>`
            error.innerHTML += `O <span style="color: green">Luizinho</span> economizou <b>R$${(economia[economia.length - 1].filho3).toFixed(2)}</b> pois fez ${filho3} depósitos <br>`
        }, "2000")
    }
